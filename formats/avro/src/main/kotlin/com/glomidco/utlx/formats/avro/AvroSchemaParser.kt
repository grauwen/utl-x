package com.glomidco.utlx.formats.avro
...
class AvroSchemaParser {
    ...
    /**
     * Enrich raw Avro UDM with USDL % properties.
    ...
    private fun parseSchema(udm: UDM): UDM {
        ...
        try {
            val jsonSerializer = com.glomidco.utlx.formats.json.JSONSerializer(false)
