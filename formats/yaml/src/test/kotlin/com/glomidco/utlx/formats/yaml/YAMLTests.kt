// formats/yaml/src/test/kotlin/com/glomidco/utlx/formats/yaml/YAMLTests.kt
package com.glomidco.utlx.formats.yaml
...
class YAMLSerializerWriteAttributesTest : DescribeSpec({
    ...
    describe("XML round-trip via parser") {
        it("default mode - parse XML and serialize to YAML") {
            ...
            val udm = com.glomidco.utlx.formats.xml.XMLParser(xml).parse()
