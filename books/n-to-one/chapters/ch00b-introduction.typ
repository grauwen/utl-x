...
The smallest mapping relates one source to one target: the *1:1* case. It is where the field's theory was developed, and it is the right place to build intuition. This book is about the larger case — many sources, one target, the *N:1* mapping of Chapter 1 — but everything in it rests on the 1:1 foundation, which Chapter 14 documents in full.
