...
[![Version](https://img.shields.io/badge/version-1.3.0-blue)](https://github.com/grauwen/utl-x/releases)
...
The wrapper scripts automatically locate and run the compiled JAR file at `modules/cli/build/libs/cli-1.3.0.jar`.
