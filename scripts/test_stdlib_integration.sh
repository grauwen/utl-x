...
java -jar modules/cli/build/libs/cli-1.2.2.jar functions --help || {
...
echo "  java -jar modules/cli/build/libs/cli-1.2.2.jar functions"
echo "  java -jar modules/cli/build/libs/cli-1.2.2.jar functions --module string"
echo "  java -jar modules/cli/build/libs/cli-1.2.2.jar functions --search date"