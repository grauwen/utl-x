...
java -jar modules/cli/build/libs/cli-1.3.1.jar functions --help || {
...
echo "  java -jar modules/cli/build/libs/cli-1.3.1.jar functions"
echo "  java -jar modules/cli/build/libs/cli-1.3.1.jar functions --module string"
echo "  java -jar modules/cli/build/libs/cli-1.3.1.jar functions --search date"