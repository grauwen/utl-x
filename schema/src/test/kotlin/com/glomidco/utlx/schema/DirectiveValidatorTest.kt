package com.glomidco.utlx.schema
...
import com.glomidco.utlx.schema.usdl.DirectiveValidator
...
class DirectiveValidatorTest : StringSpec({
    ...
    "Should detect typo in directive name with suggestion" {
        ...
        typoError shouldBe com.glomidco.utlx.schema.usdl.DirectiveValidator.ValidationResult.Error(
