// modules/cli/src/main/kotlin/com/glomidco/utlx/cli/commands/ValidateCommand.kt
...
object ValidateCommand {
    ...
    fun execute(args: Array<String>): CommandResult {
        ...
        val program = when (parseResult) {
            ...
            is ParseResult.Failure -> {
                ...
                val headerErrors = parseResult.errors.filter {
                    it.section == com.glomidco.utlx.core.parser.ScriptSection.HEADER ||
                    it.section == com.glomidco.utlx.core.parser.ScriptSection.SEPARATOR
                }
                val contentErrors = parseResult.errors.filter {
                    it.section == com.glomidco.utlx.core.parser.ScriptSection.CONTENT
                }
        ...
        if (options.schemaFile != null) {
            ...
            try {
                ...
                try {
                    val typeInference = com.glomidco.utlx.analysis.types.AdvancedTypeInference()
    ...
    data class ValidationError(
        ...
        val message: String,
        val location: com.glomidco.utlx.core.ast.Location,
        val code: String
    )
