...
class HttpTransportTest {
    ...
    private fun loadTransformationWithTopicConfig(name: String, topic: String) {
        ...
        val updatedConfig = instance.config.copy(
            input = com.glomidco.utlx.engine.config.MessagingEndpoint(topic = topic, subscription = "utlxe")
        )
        val updated = com.glomidco.utlx.engine.registry.TransformationInstance(
