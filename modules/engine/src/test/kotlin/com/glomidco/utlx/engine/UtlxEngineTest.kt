...
class UtlxEngineTest {
    ...
    fun `cannot start without initialize`() {
        ...
        assertFailsWith<IllegalArgumentException> {
            engine.start(com.glomidco.utlx.engine.transport.StdioJsonTransport())
        }
    }
    ...
    private class FakeTransport(override val name: String) : com.glomidco.utlx.engine.transport.TransportServer {
        ...
        override fun start(registry: com.glomidco.utlx.engine.registry.TransformationRegistry) {
            startCount++
