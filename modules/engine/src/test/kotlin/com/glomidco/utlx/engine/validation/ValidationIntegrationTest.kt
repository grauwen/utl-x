package com.glomidco.utlx.engine.validation
...
import com.glomidco.utlx.engine.config.EngineSettings
import com.glomidco.utlx.engine.config.HealthConfig
import com.glomidco.utlx.engine.config.MonitoringConfig
import com.glomidco.utlx.engine.proto.BatchItem
import com.glomidco.utlx.engine.proto.ExecuteRequest
import com.glomidco.utlx.engine.proto.LoadTransformationRequest
import com.glomidco.utlx.engine.proto.UtlxeServiceGrpc
import com.glomidco.utlx.engine.transport.UtlxeServiceImpl
...
class ValidationIntegrationTest {
    ...
    fun `STRICT policy rejects invalid input`() {
        ...
        assertEquals(com.glomidco.utlx.engine.proto.ErrorPhase.PRE_VALIDATION, execResp.errorPhase)
    ...
    fun `output validation catches bad transformation output`() {
        ...
        assertEquals(com.glomidco.utlx.engine.proto.ErrorPhase.POST_VALIDATION, execResp.errorPhase)
    }
    ...
    fun `transformation error returns TRANSFORMATION phase`() {
        ...
        assertTrue(execResp.success || execResp.errorPhase == com.glomidco.utlx.engine.proto.ErrorPhase.TRANSFORMATION)
    }
    ...
    fun `STRICT validation reports ALL errors not just first`() {
        ...
        assertEquals(com.glomidco.utlx.engine.proto.ErrorPhase.PRE_VALIDATION, resp.errorPhase)
    ...
    fun `output validation failure includes the output for inspection`() {
        ...
        assertFalse(resp.success)
        assertEquals(com.glomidco.utlx.engine.proto.ErrorPhase.POST_VALIDATION, resp.errorPhase)
