...
import com.glomidco.utlx.engine.transport.GrpcTransport
import com.glomidco.utlx.engine.transport.HttpTransport
import com.glomidco.utlx.engine.transport.StdioJsonTransport
import com.glomidco.utlx.engine.transport.StdioProtoTransport
...
fun main(args: Array<String>) {
    ...
    com.glomidco.utlx.engine.admin.LogBuffer.install()
    ...
    try {
        ...
        engine.bundleInfo = com.glomidco.utlx.engine.admin.detectBundleMode(dataDirPath)
        ...
        if (engine.bundleInfo.mode == "locked" && engine.bundleInfo.utlarPath != null) {
            ...
            val loaded = com.glomidco.utlx.engine.admin.loadUtlar(engine.bundleInfo.utlarPath!!, engine)
        ...
        val daprIntegration = com.glomidco.utlx.engine.admin.DaprIntegration(
