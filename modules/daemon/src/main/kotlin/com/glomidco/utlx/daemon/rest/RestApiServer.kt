...
import com.glomidco.utlx.analysis.schema.XSDSchemaParser
import com.glomidco.utlx.analysis.schema.JSONSchemaParser
import com.glomidco.utlx.analysis.schema.SchemaFormat as AnalysisSchemaFormat
import com.glomidco.utlx.cli.service.TransformationService
import com.glomidco.utlx.cli.service.UDMService
...
import com.glomidco.utlx.daemon.schema.OutputSchemaInferenceService
import com.glomidco.utlx.daemon.schema.InferenceResult
import com.glomidco.utlx.formats.xml.XMLParser
import com.glomidco.utlx.formats.json.JSONParser as UtlxJSONParser
import com.glomidco.utlx.formats.json.JSONSerializer
import com.glomidco.utlx.formats.xml.XMLSerializer
import com.glomidco.utlx.formats.csv.CSVParser
import com.glomidco.utlx.formats.csv.CSVSerializer
import com.glomidco.utlx.formats.csv.CSVDialect
import com.glomidco.utlx.formats.yaml.YAMLParser
import com.glomidco.utlx.formats.yaml.YAMLSerializer
import com.glomidco.utlx.formats.xsd.XSDParser
import com.glomidco.utlx.formats.xsd.XSDSerializer
import com.glomidco.utlx.formats.jsch.JSONSchemaParser as JschParser
import com.glomidco.utlx.formats.jsch.JSONSchemaSerializer as JschSerializer
import com.glomidco.utlx.formats.avro.AvroSchemaParser
import com.glomidco.utlx.formats.avro.AvroSchemaSerializer
import com.glomidco.utlx.formats.protobuf.ProtobufSchemaParser
import com.glomidco.utlx.formats.protobuf.ProtobufSchemaSerializer
import com.glomidco.utlx.formats.odata.ODataJSONParser
import com.glomidco.utlx.formats.odata.ODataJSONSerializer
import com.glomidco.utlx.formats.osch.EDMXParser
import com.glomidco.utlx.formats.osch.EDMXSerializer
import com.glomidco.utlx.formats.tsch.TableSchemaParser as TschParser
import com.glomidco.utlx.formats.tsch.TableSchemaSerializer as TschSerializer
import com.glomidco.utlx.stdlib.StandardLibrary
import com.glomidco.utlx.stdlib.OperatorRegistry
import com.glomidco.utlx.schema.usdl.DirectiveRegistry
...
class RestApiServer(
                    ...
                    try {
                        ...
                        when (parseResult) {
                            is ParseResult.Success -> {
                                ...
                                // Run type checker
                                val stdlib = com.glomidco.utlx.core.types.StandardLibrary()
                    ...
                    try {
                        ...
                        if (request.inputSchema != null) {
                            try {
                                ...
                                val typeContext = com.glomidco.utlx.analysis.types.TypeContext(inputType = typeDef)
     ...
     */
    private fun parseInput(data: String, format: String): com.glomidco.utlx.core.udm.UDM {
    ...
    private fun parseInputBytes(
        ...
        encoding: String,
        hasBOM: Boolean
    ): com.glomidco.utlx.core.udm.UDM {
    ...
    private fun serializeOutput(
        udm: com.glomidco.utlx.core.udm.UDM,
        format: String,
        pretty: Boolean
    ): String {
        return when (format.lowercase()) {
     ...
     */
    private fun serializeTypeDefinition(typeDef: com.glomidco.utlx.analysis.types.TypeDefinition): String {
        ...
        when (typeDef) {
            is com.glomidco.utlx.analysis.types.TypeDefinition.Scalar -> {
                jsonObj["type"] = "scalar"
                jsonObj["kind"] = typeDef.kind.name.lowercase()
            }
            is com.glomidco.utlx.analysis.types.TypeDefinition.Object -> {
                jsonObj["type"] = "object"
            ...
            is com.glomidco.utlx.analysis.types.TypeDefinition.Array -> {
                jsonObj["type"] = "array"
                jsonObj["elementType"] = describeType(typeDef.elementType)
            }
            is com.glomidco.utlx.analysis.types.TypeDefinition.Union -> {
                jsonObj["type"] = "union"
                jsonObj["types"] = typeDef.types.map { describeType(it) }
            }
            is com.glomidco.utlx.analysis.types.TypeDefinition.Any -> {
                jsonObj["type"] = "any"
            }
            is com.glomidco.utlx.analysis.types.TypeDefinition.Unknown -> {
                jsonObj["type"] = "unknown"
            }
            is com.glomidco.utlx.analysis.types.TypeDefinition.Never -> {
                jsonObj["type"] = "never"
            }
        }
     ...
     */
    private fun describeType(typeDef: com.glomidco.utlx.analysis.types.TypeDefinition): String {
        return when (typeDef) {
            is com.glomidco.utlx.analysis.types.TypeDefinition.Scalar -> typeDef.kind.name.lowercase()
            is com.glomidco.utlx.analysis.types.TypeDefinition.Object -> "object"
            is com.glomidco.utlx.analysis.types.TypeDefinition.Array -> "array<${describeType(typeDef.elementType)}>"
            is com.glomidco.utlx.analysis.types.TypeDefinition.Union -> typeDef.types.joinToString(" | ") { describeType(it) }
            is com.glomidco.utlx.analysis.types.TypeDefinition.Any -> "any"
            is com.glomidco.utlx.analysis.types.TypeDefinition.Unknown -> "unknown"
            is com.glomidco.utlx.analysis.types.TypeDefinition.Never -> "never"
        }
    }
