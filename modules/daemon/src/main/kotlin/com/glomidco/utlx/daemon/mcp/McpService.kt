// modules/server/src/main/kotlin/com/glomidco/utlx/server/mcp/McpService.kt
package com.glomidco.utlx.daemon.mcp
...
class McpService(
    ...
    suspend fun validate(request: ValidateRequest): ValidateResponse {
        try {
            ...
            try {
                ...
                when (parseResult) {
                    is com.glomidco.utlx.core.parser.ParseResult.Failure -> {
                        // Add parse errors
                    ...
                    is com.glomidco.utlx.core.parser.ParseResult.Success -> {
    ...
    private fun executeScript(scriptText: String, input: Any?): Any {
        ...
        val program = when (parseResult) {
            ...
            is com.glomidco.utlx.core.parser.ParseResult.Success -> parseResult.program
        }
