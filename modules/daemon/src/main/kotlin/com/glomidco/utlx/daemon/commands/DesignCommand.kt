// modules/server/src/main/kotlin/com/glomidco/utlx/server/commands/DesignCommand.kt
...
import com.glomidco.utlx.analysis.validation.TransformValidator
...
import com.glomidco.utlx.daemon.UTLXDaemon
import com.glomidco.utlx.daemon.TransportType
import java.io.File
...
object DesignCommand {
    ...
    private fun executeGraph(args: Array<String>): CommandResult {
        ...
        // Generate DOT graph
        val visualizer = com.glomidco.utlx.analysis.visualization.GraphvizASTVisualizer()
        val options = com.glomidco.utlx.analysis.visualization.VisualizationOptions(layout = layout)
