// modules/daemon/src/test/kotlin/com/glomidco/utlx/daemon/rest/RestApiServerTest.kt
...
class RestApiServerTest {
    ...
    fun `test StandardLibrary exportRegistry returns valid registry`() {
        val registry = com.glomidco.utlx.stdlib.StandardLibrary.exportRegistry()
    ...
    fun `test function registry round-trip serialization`() {
        ...
        // Deserialize back
        val deserialized = jacksonMapper.readValue(json, com.glomidco.utlx.stdlib.FunctionRegistry::class.java)
    ...
    fun `test OperatorRegistry exportRegistry returns valid registry`() {
        val registry = com.glomidco.utlx.stdlib.OperatorRegistry.exportRegistry()
    ...
    fun `test operator registry round-trip serialization`() {
        ...
        // Deserialize back
        val deserialized = jacksonMapper.readValue(json, com.glomidco.utlx.stdlib.OperatorRegistry.OperatorRegistryData::class.java)
