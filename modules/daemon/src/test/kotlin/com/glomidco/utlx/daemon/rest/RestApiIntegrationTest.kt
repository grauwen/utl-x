// modules/daemon/src/test/kotlin/com/glomidco/utlx/daemon/rest/RestApiIntegrationTest.kt
...
Jane,25"""
    ...
    fun `test functions endpoint response can be parsed as JSON`() = runBlocking {
        ...
        assertDoesNotThrow {
            val registry = jacksonMapper.readValue(body, com.glomidco.utlx.stdlib.FunctionRegistry::class.java)
    ...
    fun `test functions endpoint multiple requests return same data`() = runBlocking {
        ...
        val registry1 = jacksonMapper.readValue(body1, com.glomidco.utlx.stdlib.FunctionRegistry::class.java)
        val registry2 = jacksonMapper.readValue(body2, com.glomidco.utlx.stdlib.FunctionRegistry::class.java)
    ...
    fun `test usdl directives endpoint response can be parsed as JSON`() = runBlocking {
        ...
        // Should not throw exception
        assertDoesNotThrow {
            val registry = jacksonMapper.readValue(body, com.glomidco.utlx.schema.usdl.DirectiveRegistry.DirectiveRegistryData::class.java)
            assertNotNull(registry)
    ...
    fun `test usdl directives endpoint multiple requests return same data`() = runBlocking {
        ...
        val registry1 = jacksonMapper.readValue(body1, com.glomidco.utlx.schema.usdl.DirectiveRegistry.DirectiveRegistryData::class.java)
        val registry2 = jacksonMapper.readValue(body2, com.glomidco.utlx.schema.usdl.DirectiveRegistry.DirectiveRegistryData::class.java)
