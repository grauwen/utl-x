...
class JSONSchemaGeneratorTest {
    ...
    fun `should generate schema for string type`() {
        ...
        val schema = generator.generate(type, SchemaFormat.JSON_SCHEMA)
    ...
    @Test
    fun `should generate schema with description when provided`() {
        val type = TypeDefinition.Scalar(
            ScalarKind.STRING,
        ...
        // Note: Description support depends on implementation
