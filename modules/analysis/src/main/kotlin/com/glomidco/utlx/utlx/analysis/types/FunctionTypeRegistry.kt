// modules/analysis/src/main/kotlin/com/glomidco/utlx/analysis/types/FunctionTypeRegistry.kt
...
sealed class ReturnTypeLogic {
    ...
    data class Custom(val analyzer: (List<com.glomidco.utlx.core.ast.Expression>, TypeInferenceContext) -> TypeDefinition) : ReturnTypeLogic()
}
...
interface TypeInferenceContext {
    fun analyzeExpression(expression: com.glomidco.utlx.core.ast.Expression): TypeDefinition
}