package com.glomidco.utlx.core.debug
...
object DebugConfig {
    ...
    enum class Component(val loggerName: String) {
        LEXER("com.glomidco.utlx.core.lexer"),
        PARSER("com.glomidco.utlx.core.parser"),
        INTERPRETER("com.glomidco.utlx.core.interpreter"),
        TYPE_SYSTEM("com.glomidco.utlx.core.types"),
        UDM("com.glomidco.utlx.core.udm"),
        AST("com.glomidco.utlx.core.ast"),
        FORMATS("com.glomidco.utlx.formats"),
        ROOT("ROOT")
    }
