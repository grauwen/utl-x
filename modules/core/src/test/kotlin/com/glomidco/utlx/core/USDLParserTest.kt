...
import com.glomidco.utlx.core.ast.Dialect
import com.glomidco.utlx.core.ast.Expression
import com.glomidco.utlx.core.ast.FormatType
...
class USDLParserTest {
    ...
    fun `parse output xsd with usdl dialect`() {
        ...
        assertTrue(result is com.glomidco.utlx.core.parser.ParseResult.Success)
        val program = (result as com.glomidco.utlx.core.parser.ParseResult.Success).program
