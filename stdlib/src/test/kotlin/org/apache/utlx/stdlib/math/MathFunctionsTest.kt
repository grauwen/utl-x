...
class MathFunctionsTest {
    ...
    // Note: Argument validation is handled at runtime by the UTL-X engine via @UTLXFunction annotations
    // These Kotlin functions are implementation details and don't validate arguments themselves
