// stdlib/src/main/kotlin/com/glomidco/utlx/stdlib/DataWeaveAliases.kt
...
object DataWeaveAliases {
    ...
    fun daysBetween(date1: UDM, date2: UDM): UDM {
        return com.glomidco.utlx.stdlib.date.DateFunctions.diffDays(listOf(date1, date2))
    }
 ...
 */
fun com.glomidco.utlx.stdlib.StandardLibrary.registerDataWeaveAliases() {
