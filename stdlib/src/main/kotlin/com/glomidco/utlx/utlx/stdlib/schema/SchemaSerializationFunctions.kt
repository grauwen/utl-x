// stdlib/src/main/kotlin/com/glomidco/utlx/stdlib/schema/SchemaSerializationFunctions.kt
package com.glomidco.utlx.stdlib.schema
...
object SchemaSerializationFunctions {
    ...
    fun parseXSDSchema(args: List<UDM>): UDM {
        ...
        return try {
            val parser = com.glomidco.utlx.formats.xsd.XSDParser(xsdSchemaString)
    ...
    fun renderXSDSchema(args: List<UDM>): UDM {
        ...
        return try {
            val serializer = com.glomidco.utlx.formats.xsd.XSDSerializer(
    ...
    fun parseJSONSchema(args: List<UDM>): UDM {
        ...
        return try {
            val parser = com.glomidco.utlx.formats.jsch.JSONSchemaParser(jsonSchemaString)
    ...
    fun renderJSONSchema(args: List<UDM>): UDM {
        ...
        return try {
            val serializer = com.glomidco.utlx.formats.jsch.JSONSchemaSerializer(
                draft = "2020-12",
