package com.glomidco.utlx.stdlib.crypto

import com.glomidco.utlx.core.udm.UDM
import com.glomidco.utlx.core.FunctionArgumentException
 ...
 *
 * Originally in stdlib-security module, merged into stdlib/crypto as part of F11.
 */
object JWTVerification {
    ...
    internal fun serializeUDMToJSON(udm: UDM): String {
        return when (udm) {
            is UDM.Scalar -> {
    ...
    internal fun parseJSONFromBase64Url(base64Url: String): UDM {
    ...
    internal fun parseJSON(jsonString: String): UDM {
