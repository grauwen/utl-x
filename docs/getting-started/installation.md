...
**macOS (Apple Silicon):**
```bash
curl -L https://github.com/grauwen/utl-x/releases/download/v1.2.2/utlx-macos-arm64.bin -o utlx
chmod +x utlx
...
**Windows:** Download `utlx-windows-x64.exe` from the [releases page](https://github.com/grauwen/utl-x/releases/tag/v1.2.2).
...
The wrapper scripts (`utlx`, `utlx.bat`, `utlx.ps1`) automatically locate and run the compiled JAR file at `modules/cli/build/libs/cli-1.2.2.jar`.
