...
test_1.test.describe('Service Auto-Start Conformance', () => {
    (0, test_1.test)('Theia should be accessible on port 4000', async ({ page }) => {
        // Navigate to Theia
        await page.goto('/');
    ...
    (0, test_1.test)('MCP Server should be running on port 7780', async () => {
        ...
        (0, test_1.expect)(stdout).toContain('7780');
    });
