...
All schema conversions go through USDL (Chapter 11) as the intermediate representation:
...
- All five design patterns: Russian Doll, Venetian Blind, Salami Slice, Garden of Eden, Swiss Army Knife (see Chapter 28)
...
OData services publish their model as EDMX metadata documents. UTL-X reads and writes these using the `osch` format. See Chapter 26 for details on OData data transformations and EDMX structure.
