...
Chapter 18 covered syntactical validation — checking that data matches a schema's structure, types, and constraints. This chapter covers the next frontier: *semantic* validation — checking that data is not just structurally correct but *meaningfully* correct.
...
- *Syntactical validation (7 schema formats):* implemented (Chapter 18)
