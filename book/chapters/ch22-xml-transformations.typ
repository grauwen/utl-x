...
When XML is transformed to JSON or YAML, attributes need special handling because JSON and YAML have no concept of attributes. Chapter 23 covers this in detail. The short version:
...
SAP exports IDocs as flat XML segments (see Chapter 21 on data restructuring for the grouping pattern):
