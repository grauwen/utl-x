...
For decomposing, constructing, and matching XML Qualified Names — essential for namespace-aware processing (UBL, XBRL, SOAP, ISO 20022). See Chapter 22 for usage examples.
...
W3C XML Canonicalization (C14N) for digital signatures, hashing, and round-trip verification. See Chapter 22 for details.
...
Chapter 50 (Part VIII) contains the complete reference — every function with its signature, parameter types, return type, description, and a runnable example. Use it as a desk reference.
