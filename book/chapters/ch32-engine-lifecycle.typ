...
#table(
  ...
  [COPY + COMPILED], [Build skeleton DOM _and_ compile fill logic to JVM bytecode], [Paid once at init-time (seconds), before ready; then cached. Not a first-message cost.],
