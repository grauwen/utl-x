...
export interface UTLXService {
    ...
    /**
     * IF10 v2: a one-sentence semantic gloss for an input ("what kind of message is
     * this"), generated by the LLM from the deterministic abstract. Opt-in — the IDE
     * calls this only when the user clicks "Explain (AI)" in the AI dialog. Returns ''
