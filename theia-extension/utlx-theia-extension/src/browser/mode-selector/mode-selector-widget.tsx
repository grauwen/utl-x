                    ...
                    <div className='utlx-mode-options'>
                        <label className='utlx-checkbox-label'>
                            <input
                                ...
                                onChange={(e) => this.handleAutoInferSchemaChange(e.target.checked)}
                            />
                        ...
                        <label className='utlx-checkbox-label'>
                            <input
                                ...
                                onChange={(e) => this.handleTypeCheckingChange(e.target.checked)}
                            />
    ...
    private getModeDescription(mode: UTLXMode): string {
        switch (mode) {
            case UTLXMode.DESIGN_TIME:
                return '📐 Use schemas to validate transformation logic without data';
            case UTLXMode.RUNTIME:
                return '🚀 Execute transformations with actual input data';
        }
    }
            ...
            case UTLXMode.DESIGN_TIME:
                return (
                    <div className='utlx-mode-info-box'>
                        ...
                        <ul>
                            <li>✓ Load input schema (XSD, JSON Schema)</li>
                            <li>✓ Type-check transformation paths</li>
                            <li>✓ Infer output schema</li>
                            <li>✓ Catch errors before deployment</li>
                            <li>✗ No data execution</li>
                        </ul>
                    </div>
                );
            case UTLXMode.RUNTIME:
                return (
                    <div className='utlx-mode-info-box'>
                        ...
                        <ul>
                            <li>✓ Load input data (XML, JSON, CSV, YAML)</li>
                            <li>✓ Execute transformation</li>
                            <li>✓ View output data</li>
